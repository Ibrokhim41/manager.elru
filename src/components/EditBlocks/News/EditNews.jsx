                ...
                <label htmlFor="book_image3">
                    <div
                        ...
                        {news.new_data.image ? (<img
                            src={typeof news.new_data.image == "object" ? URL.createObjectURL(news.new_data.image) : news.new_data.image}
                ...
                <label htmlFor="book_image4">
                    <div
                        ...
                        {news.new_data.image1 ? (<img
                            src={typeof news.new_data.image1 == "object" ? URL.createObjectURL(news.new_data.image1) : news.new_data.image1}
                            className="w-full h-full object-cover"
                            alt="banner"
                        />) : (<>
                            <IoMdImages className="text-4xl text-blue"/>
                ...
                <label htmlFor="book_image5">
                    <div
                        ...
                        {news.new_data.image2 ? (<img
                            src={typeof news.new_data.image2 == "object" ? URL.createObjectURL(news.new_data.image2) : news.new_data.image2}
                            className="w-full h-full object-cover"
                            alt="banner"
                        />) : (<>
                            <IoMdImages className="text-4xl text-blue"/>
