        ...
        <div className="h-screen overflow-hidden">
            ...
            <div className="border-b-2 border-grey-border h-32 bg-gradient-to-r from-grey-bg to-white">
                <div className="container mx-auto grid grid-cols-12">
                    {/* left */}
                    <div
                        className="col-span-7 sm:col-span-6 md:col-span-3 h-32 flex items-center justify-center pt-14 border-r border-grey-border">
                    ...
                    {/* right */}
                    <div
                        className="col-span-5 sm:col-span-6 md:col-span-9 h-32 flex pl-4 items-center border-l border-b-2 pt-14 border-grey-border bg-white">
                        <div
                            style={{
            ...
            <div className="bg-gradient-to-r from-grey-bg to-white">
                <div className="2xl:container mx-auto grid grid-cols-12">
                    {/* left */}
                    <div
                        className={`z-40 transform transition-all ${showMenu ? 'translate-x-0' : '-translate-x-full 2xl:translate-x-0'} absolute 2xl:static left-0 flex w-11/12 sm:w-1/2 md:w-1/3 2xl:w-full 2xl:col-span-3 bg-grey-bg border-r border-grey-border`}>
                    ...
                    {/* right */}
                    <div
                        className="col-span-12 2xl:col-span-9 h-screen pb-44 pl-4 border-l border-grey-border bg-white overflow-scroll">
                        {/* user */}
                        <div className="grid grid-cols-12">
                            <div className="col-start-1 sm:col-start-5 xl:col-start-7 col-end-13 flex flex-col py-4">
                                <div className="flex">
                                    {/* message */}
                                    <div
                                        className="bg-grey-light text-grey-dark ctext-base font-medium rounded-md p-3 mr-4">
                        ...
                        <div className="relative mt-5 mr-5 sm:mt-10">
                            ...
                            />
                            <button
                                className="absolute top-0 right-0 h-full flex items-center px-5 bg-blue rounded-r-md">
