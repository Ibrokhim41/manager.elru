  ...
  return (
    <div className="container mx-auto">
      ...
      <div className="flex flex-col md:flex-row">
        <button className="bg-blue text-white ctext-base font-medium py-1.5 px-8 rounded-md flex items-center justify-center">
      ...
      <div>
        <div className="w-full md:w-9/12 grid grid-cols-12">
          ...
          <div className="col-span-11 text-grey-dark ctext-sm font-medium border border-grey-border py-1.5 px-2">
            Название
          </div>
        </div>
        {/*  */}
          ...
          {list.map((item) => {
            return (
              <>
                ...
                <div className="col-span-11 flex justify-between items-center text-grey-dark ctext-sm font-medium border border-grey-border py-1.5 px-2">
                  {item}
                  <div
